const Sidebar = () => {
  return (
    <div className="h-screen w-1/5 mx-16 flex flex-col justify-center gap-8">
      <div>
        ...
        <div className="text-lg">
          ...
          <ol className="list-decimal">
            <li>Each 3 by 3 region contains all digits from 1 to 9</li>
            <li>
              Each column in the 9 by 9 grid contain all digits from 1 to 9
            </li>
            <li>Each row in the 9 by 9 grid has all contain from 1 to 9</li>
          </ol>
        </div>
      </div>
      <div>
